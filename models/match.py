...
class Match:
    ...
    def set_up_pieces(self):
        self.board.houses[0][0].set_piece(Rook(0, 0, BLACK, images.black_rook, self.board.houses[0][0]))
        self.board.houses[1][0].set_piece(Horse(1, 0, BLACK, images.black_horse, self.board.houses[1][0]))
        self.board.houses[2][0].set_piece(Bishop(2, 0, BLACK, images.black_bishop, self.board.houses[2][0]))
        self.board.houses[3][0].set_piece(Queen(3, 0, BLACK, images.black_queen, self.board.houses[3][0]))
        self.board.houses[4][0].set_piece(King(4, 0, BLACK, images.black_king, self.board.houses[4][0]))
        self.board.houses[5][0].set_piece(Bishop(5, 0, BLACK, images.black_bishop, self.board.houses[5][0]))
        self.board.houses[6][0].set_piece(Horse(6, 0, BLACK, images.black_horse, self.board.houses[6][0]))
        self.board.houses[7][0].set_piece(Rook(7, 0, BLACK, images.black_rook, self.board.houses[7][0]))

        self.board.houses[0][1].set_piece(Pawn(0, 1, BLACK, images.black_pawn, self.board.houses[0][1]))
        self.board.houses[1][1].set_piece(Pawn(1, 1, BLACK, images.black_pawn, self.board.houses[1][1]))
        self.board.houses[2][1].set_piece(Pawn(2, 1, BLACK, images.black_pawn, self.board.houses[2][1]))
        self.board.houses[3][1].set_piece(Pawn(3, 1, BLACK, images.black_pawn, self.board.houses[3][1]))
        self.board.houses[4][1].set_piece(Pawn(4, 1, BLACK, images.black_pawn, self.board.houses[4][1]))
        self.board.houses[5][1].set_piece(Pawn(5, 1, BLACK, images.black_pawn, self.board.houses[5][1]))
        self.board.houses[6][1].set_piece(Pawn(6, 1, BLACK, images.black_pawn, self.board.houses[6][1]))
        self.board.houses[7][1].set_piece(Pawn(7, 1, BLACK, images.black_pawn, self.board.houses[7][1]))

        self.board.houses[0][7].set_piece(Rook(0, 7, WHITE, images.white_rook, self.board.houses[0][7]))
        self.board.houses[1][7].set_piece(Horse(1, 7, WHITE, images.white_horse, self.board.houses[1][7]))
        self.board.houses[2][7].set_piece(Bishop(2, 7, WHITE, images.white_bishop, self.board.houses[2][7]))
        self.board.houses[3][7].set_piece(Queen(3, 7, WHITE, images.white_queen, self.board.houses[3][7]))
        self.board.houses[4][7].set_piece(King(4, 7, WHITE, images.white_king, self.board.houses[4][7]))
        self.board.houses[5][7].set_piece(Bishop(5, 7, WHITE, images.white_bishop, self.board.houses[5][7]))
        self.board.houses[6][7].set_piece(Horse(6, 7, WHITE, images.white_horse, self.board.houses[6][7]))
        self.board.houses[7][7].set_piece(Rook(7, 7, WHITE, images.white_rook, self.board.houses[7][7]))
        self.board.houses[0][6].set_piece(Pawn(0, 6, WHITE, images.white_pawn, self.board.houses[0][6]))
        self.board.houses[1][6].set_piece(Pawn(1, 6, WHITE, images.white_pawn, self.board.houses[1][6]))
        self.board.houses[2][6].set_piece(Pawn(2, 6, WHITE, images.white_pawn, self.board.houses[2][6]))
        self.board.houses[3][6].set_piece(Pawn(3, 6, WHITE, images.white_pawn, self.board.houses[3][6]))
        self.board.houses[4][6].set_piece(Pawn(4, 6, WHITE, images.white_pawn, self.board.houses[4][6]))
        self.board.houses[5][6].set_piece(Pawn(5, 6, WHITE, images.white_pawn, self.board.houses[5][6]))
        self.board.houses[6][6].set_piece(Pawn(6, 6, WHITE, images.white_pawn, self.board.houses[6][6]))
        self.board.houses[7][6].set_piece(Pawn(7, 6, WHITE, images.white_pawn, self.board.houses[7][6]))
