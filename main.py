...
def draw(self):
    ...
    self.board[0][0] = Piece(0, 0, "black", 1)
    self.board[0][1] = Piece(0, 1, "black", 2)
    self.board[0][2] = Piece(0, 2, "black", 3)
    self.board[0][3] = Piece(0, 3, "black", 4)
    self.board[0][4] = Piece(0, 4, "black", 5)
    self.board[0][5] = Piece(0, 5, "black", 3)
    self.board[0][6] = Piece(0, 6, "black", 2)
    self.board[0][7] = Piece(0, 7, "black", 1)

    self.board[1][0] = Piece(1, 0, "black", 0)
    self.board[1][1] = Piece(1, 1, "black", 0)
    self.board[1][2] = Piece(1, 2, "black", 0)
    self.board[1][3] = Piece(1, 3, "black", 0)
    self.board[1][4] = Piece(1, 4, "black", 0)
    self.board[1][5] = Piece(1, 5, "black", 0)
    self.board[1][6] = Piece(1, 6, "black", 0)
    self.board[1][7] = Piece(1, 7, "black", 0)

    self.board[7][0] = Piece(7, 0, "white", 1)
    self.board[7][1] = Piece(7, 1, "white", 2)
    self.board[7][2] = Piece(7, 2, "white", 3)
    self.board[7][3] = Piece(7, 3, "white", 4)
    self.board[7][4] = Piece(7, 4, "white", 5)
    self.board[7][5] = Piece(7, 5, "white", 3)
    self.board[7][6] = Piece(7, 6, "white", 2)
    self.board[7][7] = Piece(7, 7, "white", 1)

    self.board[6][0] = Piece(6, 0, "white", 0)
    self.board[6][1] = Piece(6, 1, "white", 0)
    self.board[6][2] = Piece(6, 2, "white", 0)
    self.board[6][3] = Piece(6, 3, "white", 0)
    self.board[6][4] = Piece(6, 4, "white", 0)
    self.board[6][5] = Piece(6, 5, "white", 0)
    self.board[6][6] = Piece(6, 6, "white", 0)
    self.board[6][7] = Piece(6, 7, "white", 0)
